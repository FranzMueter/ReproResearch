...
image(wind.fit.seq, temp.fit.seq, ozo1.fit, col = topo.colors(80), 
      xlab="Wind", ylab="Temp", cex.axis=1.2, cex.lab=1.4)
# Add contours:
...
# The model does not fit very well at high wind speeds and tempertures as there are no real data to for comparison. I would be skeptical of these large(ish) ozone gradients in high wind and temp locations.
```
